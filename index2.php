...
<?php elseif( $page_flag === 2 ): ?>
  ...
  <div>
    ...
    <!-- 続けて新規登録を行なう -->
    <input type="button" name="btn_continue" onclick="location.href='index2.php'" value="続けて登録する">
  </div>
  ...
  <?php endif; ?>
    ...
    <form method="post" action="" >
      <div class="input_new">
        ...
        <div class="btn_1">
        <!--       <input type="button" name="btn_li" onclick="location.href='list.html?ListS=1'" value="◀ 本リスト">-->
          <input type="button" name="btn_li" onclick="location.href='list1.php'" value="◀ 本リスト">
        <!-- 確認ページに移行する -->
